...
const MiaBotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M25,55 C25,35 75,35 75,55 C75,75 60,85 50,85 C40,85 25,75 25,55 Z" fill="url(#body-grad)" stroke="#bae6fd" strokeWidth="2"/>
        ...
        <line x1="50" y1="35" x2="50" y2="25" stroke="#bae6fd" strokeWidth="2" />
        <circle cx="50" cy="22" r="3" fill="#0ea5e9" stroke="white" strokeWidth="1" />
    </svg>
);
